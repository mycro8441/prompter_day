...
const ColorCircle = styled.div<{color:string}>`
    ...
    border: 2px solid transparent;
    border-radius: 1em;
    background-image: ${p=>`linear-gradient(${p.color+"5A"}, ${p.color}), linear-gradient(to bottom, ${p.color+"99"} 0%,  ${p.color} 100%)`};
    background-origin: border-box;
    background-clip: content-box, border-box;
...
const Create = () => {
    ...
    <Btn>
        <div>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.823 5.90625C15.9347 6.4218 15.9527 6.94915 15.8792 7.46518C17.7094 7.90203 19.1523 9.2766 19.6287 11.0528L19.6983 11.3123C20.1955 13.1661 20.0758 15.1246 19.3563 16.9086L19.2718 17.1181C18.5 19.0317 16.7426 20.4081 14.6498 20.7383L13.9687 20.8457C12.6648 21.0514 11.3352 21.0514 10.0313 20.8457L9.35019 20.7383C7.25734 20.4081 5.49999 19.0317 4.72818 17.1181L4.64368 16.9085C3.92417 15.1246 3.80447 13.1661 4.30168 11.3124L4.3713 11.0528C4.8477 9.2766 6.2906 7.90203 8.12084 7.46518C8.04731 6.94915 8.06527 6.4218 8.17701 5.90625C8.49089 4.45802 9.68081 3.33947 11.1843 3.07933L11.2912 3.06084C11.76 2.97972 12.24 2.97972 12.7088 3.06084L12.8157 3.07933C14.3192 3.33947 15.5091 4.45802 15.823 5.90625ZM11.5451 4.43887C11.846 4.38682 12.154 4.38682 12.4549 4.43887L12.5617 4.45736C13.4853 4.61717 14.2163 5.30429 14.4091 6.19394C14.4823 6.53164 14.4974 6.87666 14.4557 7.21544C12.8264 6.99713 11.1736 6.99713 9.54426 7.21544C9.5026 6.87666 9.5177 6.53164 9.59089 6.19394C9.78371 5.30429 10.5147 4.61717 11.4383 4.45736L11.5451 4.43887Z" fill="#CACAD0"/>
            </svg>
            <h2>직종을 선택해주세요.</h2>
        </div>
    ...
    <Btn>
        <div>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
               <path d="M16.3027 15.3365H6.68V20.1818C6.68 20.6337 6.30392 21 5.84 21C5.37608 21 5 20.6337 5 20.1818V3.81818C5 3.36631 5.37608 3 5.84 3H16.3027C17.4037 3 18.2506 3.65926 18.6739 4.48207C19.0965 5.30334 19.1414 6.35681 18.6123 7.28021L18.1096 8.15756C17.757 8.77312 17.757 9.56335 18.1096 10.1789L18.6123 11.0563C19.1414 11.9797 19.0965 13.0331 18.6739 13.8544C18.2506 14.6772 17.4037 15.3365 16.3027 15.3365Z" fill="#CACAD0"/>
            </svg>
