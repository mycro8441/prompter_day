...
const PlusBtn = styled.div`
  ...
  border-radius: 3em;
  background-image: ${(p) =>
    `linear-gradient(${p.theme.colors.blue + '99'}, ${
      p.theme.colors.blue + '99'
    }), linear-gradient(to bottom, #96A0FF 0%, ${
      p.theme.colors.blue + '99'
    } 100%)`};
      ...
      <PlusBtn>
        ...
        >
          <g id="COCO/Bold/User-plus">
            <g id="Vector">
              <path
                d="M14.8 4C11.0445 4 8 7.04446 8 10.8C8 14.5555 11.0445 17.6 14.8 17.6C18.5555 17.6 21.6 14.5555 21.6 10.8C21.6 7.04446 18.5555 4 14.8 4Z"
                fill="#F8F8FD"
              />
              <path
                d="M18.8129 20.6252C16.1545 20.201 13.4455 20.201 10.7871 20.6252L10.5021 20.6707C6.75628 21.2685 4 24.4996 4 28.2929C4 30.3403 5.65975 32 7.70715 32H21.8929C23.9403 32 25.6 30.3403 25.6 28.2929C25.6 24.4996 22.8437 21.2685 19.0979 20.6707L18.8129 20.6252Z"
                fill="#F8F8FD"
              />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M27.6 13.6C28.2627 13.6 28.8 14.1373 28.8 14.8V16.8H30.8C31.4627 16.8 32 17.3373 32 18C32 18.6627 31.4627 19.2 30.8 19.2H28.8V21.2C28.8 21.8627 28.2627 22.4 27.6 22.4C26.9373 22.4 26.4 21.8627 26.4 21.2V19.2H24.4C23.7373 19.2 23.2 18.6627 23.2 18C23.2 17.3373 23.7373 16.8 24.4 16.8H26.4V14.8C26.4 14.1373 26.9373 13.6 27.6 13.6Z"
                fill="#F8F8FD"
              />
            </g>
          </g>
